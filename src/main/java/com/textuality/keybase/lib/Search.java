...
public class Search {
	...
	public static void main(
			String[] args) throws KeybaseException {

		JSONObject result = getFromKeybase("_/api/1.0/user/autocomplete.json?q=", args[0]);

		try {
			JSONArray jsonArray = JWalk.getArray(result, "completions");
